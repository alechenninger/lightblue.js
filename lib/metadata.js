...
LightblueMetadataClient.prototype.removeEntity = function(entityName) {
  return this._execute(new RemoveEntityRequest(this._host, entityName));
};

function RemoveEntityRequest(host, entityName) {
  if (isEmpty(entityName)) {
    throw new Error("entityName is required to remove it");
  }

  HttpRequest.call(this, "delete", resolve(host, entityName));
}

RemoveEntityRequest.prototype = Object.create(HttpRequest.prototype);
RemoveEntityRequest.prototype.constructor = RemoveEntityRequest;

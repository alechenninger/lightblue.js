...
function NamesRequest(host, statuses) {
  ...
  RestRequest.call(this, "get", resolve(host, query));
}
...
function VersionsRequest(host, entityName) {
  ...
  RestRequest.call(this, "get", resolve(host, entityName));
}
...
function RolesRequest(host, entityName, version) {
  RestRequest.call(this, "get", resolve(host, entityName, version, "roles"));
}

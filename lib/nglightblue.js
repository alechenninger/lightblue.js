...
if (isNgPresent()) {
  angular.module("lightblue", [])
    ...
    .service("lightblue.nghttpclient", ["$http", NgHttpClient])
...
LightblueDataClientProvider.prototype.$get = ["lightblue.nghttpclient",
  function(httpClient) {
...
LightblueMetadataClientProvider.prototype.$get = ["lightblue.nghttpclient",
  function(httpClient) {

(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.lightblue = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
function LightblueClient(t,e){this.data=t,this.metadata=e}module.exports=LightblueClient;
},{}],2:[function(require,module,exports){
function ifDefined(e,t){return isDefined(e)?e:t}function isDefined(e){return"undefined"!=typeof e}function isObject(e){return"object"==typeof e}exports.resolve=function(){function e(e){return"string"!=typeof e?"":(e=e.replace(new RegExp("^/*"),""),e=e.replace(new RegExp("/*$"),""))}function t(e){return"undefined"!=typeof e&&""!==e}return 0===arguments.length?"":Array.prototype.slice.call(arguments,0).filter(t).map(e).join("/")},exports.isEmpty=function(e){return"undefined"==typeof e||""===e};var assertArg={isInstance:function(e,t,n){if(!(e instanceof t))throw new Error("Expected instanceof "+t+" but "+n+" was "+isObject(e)?e.constructor:"undefined");return e},isNotBlankString:function(e,t){if("string"!=typeof e)throw new Error("Expected a string but "+t+" was "+typeof e);if(0===e.trim().length)throw new Error("Expected non-blank string but "+t+" was empty.");return e},isTypeOf:function(e,t,n){if(typeof e!==t)throw new Error("Expected a typeof "+t+" but "+n+" was "+typeof e);return e}};exports.assertArg=assertArg,exports.ifDefined=ifDefined,exports.isDefined=isDefined,exports.isObject=isObject;
},{}],3:[function(require,module,exports){
function LightblueDataClient(e,t){this._httpClient=e,this._host=t}function FindRequest(e,t){var o=resolve(e,"find",t.entity,t.version),r={objectType:t.entity,version:t.version,query:t.query,projection:t.projection};t.sort instanceof Object&&Object.keys(t.sort).length>0&&(r.sort=t.sort),t.range&&(r.range=[],r.range[0]=t.range.from||t.range[0]||0,r.range[1]=t.range.to||t.range[1]),HttpRequest.call(this,"post",o,r)}function InsertRequest(e,t){var o=resolve(e,"insert",t.entity,t.version),r={objectType:t.entity,version:t.version,data:t.data,projection:t.projection};HttpRequest.call(this,"put",o,r)}function SaveRequest(e,t){var o=resolve(e,"save",t.entity,t.version),r={objectType:t.entity,version:t.version,data:t.data,upsert:t.upsert,projection:t.projection};HttpRequest.call(this,"post",o,r)}function UpdateRequest(e,t){var o=resolve(e,"update",t.entity,t.version),r={objectType:t.entity,version:t.version,query:t.query,update:t.update,projection:t.projection};HttpRequest.call(this,"post",o,r)}function DeleteRequest(e,t){var o=resolve(e,"delete",t.entity,t.version),r={objectType:t.entity,version:t.version,query:t.query};HttpRequest.call(this,"post",o,r)}var resolve=require("./clientutil").resolve,http=require("./http"),HttpRequest=http.HttpRequest;module.exports=LightblueDataClient,LightblueDataClient.prototype._execute=function(e){return this._httpClient.execute(e)},LightblueDataClient.prototype.find=function(e){return this._execute(new FindRequest(this._host,e))},LightblueDataClient.prototype.insert=function(e){return this._execute(new InsertRequest(this._host,e))},LightblueDataClient.prototype.update=function(e){return this._execute(new UpdateRequest(this._host,e))},LightblueDataClient.prototype.save=function(e){return this._execute(new SaveRequest(this._host,e))},LightblueDataClient.prototype["delete"]=function(e){return this._execute(new DeleteRequest(this._host,e))},FindRequest.prototype=Object.create(HttpRequest.prototype),FindRequest.prototype.constructor=FindRequest,InsertRequest.prototype=Object.create(HttpRequest.prototype),InsertRequest.prototype.constructor=InsertRequest,SaveRequest.prototype=Object.create(HttpRequest.prototype),SaveRequest.prototype.constructor=SaveRequest,UpdateRequest.prototype=Object.create(HttpRequest.prototype),UpdateRequest.prototype.constructor=UpdateRequest,DeleteRequest.prototype=Object.create(HttpRequest.prototype),DeleteRequest.prototype.constructor=DeleteRequest;
},{"./clientutil":2,"./http":4}],4:[function(require,module,exports){
var assertArg=require("./clientutil.js").assertArg;exports.HttpRequest=function(t,s,r){this.method=assertArg.isNotBlankString(t,"method"),this.url=assertArg.isTypeOf(s,"string","url"),this.body=r,this.METHOD=this.method.toUpperCase()};
},{"./clientutil.js":2}],5:[function(require,module,exports){
function getDataClient(t,e){return new DataClient(getHttpClient(e),t)}function getMetadataClient(t,e){return new MetadataClient(getHttpClient(e),t)}function getClient(t,e,n){"string"!=typeof e&&("object"==typeof e&&(n=e),t=resolve(t,"data"),e=resolve(t,"metadata"));var i=getDataClient(t,n),a=getMetadataClient(e,n);return new LightblueClient(i,a)}function getHttpClient(t){return ngIsPresent()&&"object"==typeof t&&"$http"in t?new NgHttpClient(t.$http,t.auth):new NodeHttpClient(t)}var DataClient=require("./data.js"),MetadataClient=require("./metadata.js"),LightblueClient=require("./client.js"),query=require("./query.js"),NodeHttpClient=require("./nodehttp.js"),NgHttpClient=require("./nghttp.js"),isNgPresent=require("./nglightblue.js").isNgPresent,resolve=require("./clientutil.js").resolve;exports.getDataClient=getDataClient,exports.getMetadataClient=getMetadataClient,exports.getClient=getClient,exports.query=query;
},{"./client.js":1,"./clientutil.js":2,"./data.js":3,"./metadata.js":6,"./nghttp.js":7,"./nglightblue.js":8,"./nodehttp.js":9,"./query.js":10}],6:[function(require,module,exports){
function LightblueMetadataClient(t,e){this._httpClient=t,this._host=e}function NamesRequest(t,e){var o=e&&e.length>0?"s="+e.join(","):"";HttpRequest.call(this,"get",resolve(t,o))}function VersionsRequest(t,e){if(isEmpty(e))throw new Error("entityName required for versions request.");HttpRequest.call(this,"get",resolve(t,e))}function MetadataRequest(t,e,o){if(isEmpty(e)||isEmpty(o))throw new Error("entityName and version required for metadata request.");HttpRequest.call(this,"get",resolve(t,e,o))}function RolesRequest(t,e,o){HttpRequest.call(this,"get",resolve(t,e,o,"roles"))}function DependenciesRequest(t,e,o){if(isEmpty(e)&&!isEmpty(o))throw new Error("entityName required with version for dependencies request");HttpRequest.call(this,"get",resolve(t,e,o,"dependencies"))}function PutMetadataRequest(t,e){var o,s;if(!(util.isObject(e)&&util.isObject(e.entityInfo)&&util.isObject(e.schema)&&util.isObject(e.schema.version)))throw new Error("metadata must be a valid metadata object\n.See: https://github.com/lightblue-platform/lightblue-core/blob/master/metadata/src/main/resources/json-schema/metadata/metadata.json");if(o=e.schema.name,s=e.schema.version.value,o!==e.entityInfo.name)throw new Error("Entity name does not match in entityInfo and schema.");if(isEmpty(o)||isEmpty(s))throw new Error("Entity name and version required in metadata");HttpRequest.call(this,"put",resolve(t,o,s))}function AddSchemaRequest(t,e){var o,s;if(util.isObject(e)&&util.isObject(e.version)&&(o=e.name,s=e.version.value),isEmpty(o)||isEmpty(s))throw new Error("Entity name and version required in schema");HttpRequest.call(this,"put",resolve(t,o,"schema="+s))}function UpdateEntityInfoRequest(t,e){var o;if(util.isObject(e)&&(o=e.name),isEmpty(o))throw new Error("Entity name required in entityInfo");HttpRequest.call(this,"put",resolve(t,o))}function UpdateSchemaStatusRequest(t,e,o,s,r){if(isEmpty(e)||isEmpty(o)||isEmpty(s))throw new Error("entityName, version, and status are required.");var i=s.toLowerCase();if(-1===["active","deprecated","disabled"].indexOf(i))throw new Error("Status was '"+i+"' but must be one of: 'active', 'deprecated', 'disabled'");var a=isEmpty(r)?resolve(t,e,o,s):resolve(t,e,o,s+"?comment="+encodeURIComponent(r));HttpRequest.call(this,"put",a)}function RemoveDefaultVersionRequest(t,e){if(isEmpty(e))throw new Error("entityName required to remove default version");HttpRequest.call(this,"delete",resolve(t,e,"default"))}function SetDefaultVersionRequest(t,e,o){if(isEmpty(e))throw new Error("entityName is required to set default version");if(isEmpty(o))throw new Error("version is required to set default version");HttpRequest.call(this,"post",resolve(t,e,o,"default"))}function RemoveEntityRequest(t,e){if(isEmpty(e))throw new Error("entityName is required to remove it");HttpRequest.call(this,"delete",resolve(t,e))}var util=require("./clientutil"),http=require("./http"),isEmpty=util.isEmpty,resolve=util.resolve,HttpRequest=http.HttpRequest;module.exports=LightblueMetadataClient,LightblueMetadataClient.prototype._execute=function(t){return this._httpClient.execute(t)},LightblueMetadataClient.prototype.getNames=function(t){return this._execute(new NamesRequest(this._host,t))},NamesRequest.prototype=Object.create(HttpRequest.prototype),NamesRequest.prototype.constructor=NamesRequest,LightblueMetadataClient.prototype.getVersions=function(t){return this._execute(new VersionsRequest(this._host,t))},VersionsRequest.prototype=Object.create(HttpRequest.prototype),VersionsRequest.prototype.constructor=VersionsRequest,LightblueMetadataClient.prototype.getMetadata=function(t,e){return this._execute(new MetadataRequest(this._host,t,e))},MetadataRequest.prototype=Object.create(HttpRequest.prototype),MetadataRequest.prototype.constructor=MetadataRequest,LightblueMetadataClient.prototype.getRoles=function(t,e){return this._execute(new RolesRequest(this._host,t,e))},RolesRequest.prototype=Object.create(HttpRequest.prototype),RolesRequest.prototype.constructor=RolesRequest,LightblueMetadataClient.prototype.getDependencies=function(t,e){return this._execute(new DependenciesRequest(this._host,t,e))},DependenciesRequest.prototype=Object.create(HttpRequest.prototype),DependenciesRequest.prototype.constructor=DependenciesRequest,LightblueMetadataClient.prototype.putMetadata=function(t){return this._execute(new PutMetadataRequest(this._host,t))},PutMetadataRequest.prototype=Object.create(HttpRequest.prototype),PutMetadataRequest.prototype.constructor=PutMetadataRequest,LightblueMetadataClient.prototype.addSchema=function(t){return this._execute(new AddSchemaRequest(this._host,t))},AddSchemaRequest.prototype=Object.create(HttpRequest.prototype),AddSchemaRequest.prototype.constructor=AddSchemaRequest,LightblueMetadataClient.prototype.updateEntityInfo=function(t){return this._execute(new UpdateEntityInfoRequest(this._host,t))},UpdateEntityInfoRequest.prototype=Object.create(HttpRequest.prototype),UpdateEntityInfoRequest.prototype.constructor=UpdateEntityInfoRequest,LightblueMetadataClient.prototype.updateSchemaStatus=function(t,e,o,s){return this._execute(new UpdateSchemaStatusRequest(this._host,t,e,o,s))},LightblueMetadataClient.prototype.activateSchema=function(t,e,o){return this.updateSchemaStatus(t,e,"active",o)},LightblueMetadataClient.prototype.deprecateSchema=function(t,e,o){return this.updateSchemaStatus(t,e,"deprecated",o)},LightblueMetadataClient.prototype.disableSchema=function(t,e,o){return this.updateSchemaStatus(t,e,"disabled",o)},UpdateSchemaStatusRequest.prototype=Object.create(HttpRequest.prototype),UpdateSchemaStatusRequest.prototype.constructor=UpdateSchemaStatusRequest,LightblueMetadataClient.prototype.removeDefaultVersion=function(t){return this._execute(new RemoveDefaultVersionRequest(this._host,t))},RemoveDefaultVersionRequest.prototype=Object.create(HttpRequest.prototype),RemoveDefaultVersionRequest.prototype.constructor=RemoveDefaultVersionRequest,LightblueMetadataClient.prototype.setDefaultVersion=function(t,e){return this._execute(new SetDefaultVersionRequest(this._host,t,e))},SetDefaultVersionRequest.prototype=Object.create(HttpRequest.prototype),SetDefaultVersionRequest.prototype.constructor=SetDefaultVersionRequest,LightblueMetadataClient.prototype.removeEntity=function(t){return this._execute(new RemoveEntityRequest(this._host,t))},RemoveEntityRequest.prototype=Object.create(HttpRequest.prototype),RemoveEntityRequest.prototype.constructor=RemoveEntityRequest;
},{"./clientutil":2,"./http":4}],7:[function(require,module,exports){
function NgHttpClient(t,e){this._$http=t,isObject(e)&&"username"in e&&"password"in e&&this.setAuth(e)}var Buffer=require("buffer").Buffer,util=require("./clientutil.js"),isObject=util.isObject;module.exports=NgHttpClient,NgHttpClient.prototype.setAuth=function(t){var e=new Buffer(t.username+":"+t.password),i=e.toString("Base64");this._headers={Authorization:"Basic "+i}},NgHttpClient.prototype.execute=function(t){return this._$http({method:t.method,url:t.url,data:t.body,withCredentials:!0,headers:this._headers})};
},{"./clientutil.js":2,"buffer":12}],8:[function(require,module,exports){
function LightblueProvider(t){this._clientProvider=t}function LightblueClientProvider(t,e){this._dataProvider=t,this._metadataProvider=e}function LightblueDataClientProvider(){this._host=""}function LightblueMetadataClientProvider(){this._host=""}var LightblueClient=require("./client.js"),DataClient=require("./data.js"),MetadataClient=require("./metadata.js"),NgHttpClient=require("./nghttp.js"),url=require("url"),query=require("./query.js"),isNgPresent=exports.isNgPresent=function(){return"object"==typeof angular&&null!==angular&&"module"in angular};isNgPresent()&&angular.module("lightblue",[]).provider("lightblue.data",LightblueDataClientProvider).provider("lightblue.metadata",LightblueMetadataClientProvider).provider("lightblue.client",["lightblue.dataProvider","lightblue.metadataProvider",LightblueClientProvider]).provider("lightblue",["lightblue.clientProvider",LightblueProvider]).service("lightblue.http",["$http",NgHttpClient]).value("lightblue.query",query),LightblueProvider.prototype.setHost=function(t){this._clientProvider.setHost(t)},LightblueProvider.prototype.setDataHost=function(t){this._clientProvider.setDataHost(t)},LightblueProvider.prototype.setMetadataHost=function(t){this._clientProvider.setMetadataHost(t)},LightblueProvider.prototype.$get=["lightblue.client","lightblue.query","lightblue.http",function(t,e,i){return{data:t.data,metadata:t.metadata,query:e,http:i}}],LightblueClientProvider.prototype.setHost=function(t){this.setDataHost(resolve(t,"/data")),this.setMetadataHost(resolve(t,"/metadata"))},LightblueClientProvider.prototype.setDataHost=function(t){this._dataProvider.setHost(t)},LightblueClientProvider.prototype.setMetadataHost=function(t){this._metadataProvider.setHost(t)},LightblueClientProvider.prototype.$get=["lightblue.data","lightblue.metadata",function(t,e){return{data:t,metadata:e}}],LightblueDataClientProvider.prototype.setHost=function(t){this._host=t},LightblueDataClientProvider.prototype.$get=["lightblue.http",function(t){return new DataClient(t,this._host)}],LightblueMetadataClientProvider.prototype.setHost=function(t){this._host=t},LightblueMetadataClientProvider.prototype.$get=["lightblue.http",function(t){return new MetadataClient(t,this._host)}];
},{"./client.js":1,"./data.js":3,"./metadata.js":6,"./nghttp.js":7,"./query.js":10,"url":42}],9:[function(require,module,exports){
function NodeHttpClient(t){isObject(t)&&(this._auth=ifDefined(t.auth,null),this._httpAgent=t.httpAgent,this._httpsAgent=t.httpsAgent)}var q=require("q"),http=require("http"),https=require("https"),url=require("url"),util=require("./clientutil"),isDefined=util.isDefined,ifDefined=util.ifDefined,isObject=util.isObject;module.exports=NodeHttpClient,NodeHttpClient.prototype.execute=function(t){var e=q.defer(),n=e.promise,i=0===t.url.indexOf("https"),r=i?https.request:http.request,u=isDefined(t.body)?JSON.stringify(t.body):"",o=url.parse(t.url);o.method=t.method.toUpperCase(),o.headers={"Content-Type":"application/json","Content-Length":u.length},o.agent=i?this._httpsAgent:this._httpAgent,null!==this._auth&&(o.auth=this._auth);var s=r(o,function(t){var n="";t.setEncoding("utf8"),t.on("data",function(t){n+=t}),t.on("end",function(){e.resolve(n)}),t.on("error",function(t){e.reject(t)})});return s.on("error",function(t){e.reject(t)}),s.write(u,"utf8"),s.end(),n.success=function(t){return n.then(t)},n.error=function(t){return n.then(null,t)},n};
},{"./clientutil":2,"http":17,"https":21,"q":45,"url":42}],10:[function(require,module,exports){
function QueryExpression(){}function NaryLogicalExpression(o,r){if(!(r instanceof Array))throw new Error("Expected array of expressions, got "+r);this[o]=r}function AndExpression(o){o instanceof Array||(o=Array.prototype.slice.call(arguments,0)),NaryLogicalExpression.call(this,"$and",o)}function OrExpression(o){o instanceof Array||(o=Array.prototype.slice.call(arguments,0)),NaryLogicalExpression.call(this,"$or",o)}function Field(o){this.field=o}function FieldComparison(o,r,e){this.field=o,this.op=r,this.rfield=e}function ValueComparison(o,r,e){this.field=o,this.op=r,this.rvalue=e}exports.field=function(o){return new Field(o)},exports.AndExpression=AndExpression,exports.OrExpression=OrExpression,exports.ValueComparison=ValueComparison,exports.FieldComparison=FieldComparison,QueryExpression.prototype.and=function(o){return new AndExpression(this,o)},QueryExpression.prototype.or=function(o){return new OrExpression(this,o)},NaryLogicalExpression.prototype=Object.create(QueryExpression.prototype),NaryLogicalExpression.prototype.constructor=NaryLogicalExpression,AndExpression.prototype=Object.create(NaryLogicalExpression.prototype),AndExpression.prototype.constructor=AndExpression,AndExpression.prototype.and=function(o){return new AndExpression(this.expressions.concat(o))},OrExpression.prototype=Object.create(NaryLogicalExpression.prototype),OrExpression.prototype.constructor=OrExpression,OrExpression.prototype.or=function(o){return new OrExpression(this.expressions.concat(o))},Field.prototype._comparison=function(o,r){return r instanceof Field?new FieldComparison(this.field,o,r.field):new ValueComparison(this.field,o,r)},Field.prototype.equalTo=Field.prototype.eq=function(o){return this._comparison("$eq",o)},Field.prototype.greaterThan=Field.prototype.gt=function(o){return this._comparison("$gt",o)},FieldComparison.prototype=Object.create(QueryExpression.prototype),FieldComparison.prototype.constructor=FieldComparison,ValueComparison.prototype=Object.create(QueryExpression.prototype),ValueComparison.prototype.constructor=ValueComparison;

...
function getDataClient(e,t){return new DataClient(getHttpClient(t),e)}function getMetadataClient(e,t){return new MetadataClient(getHttpClient(t),e)}function getClient(e,t,a){"string"!=typeof t&&("object"==typeof t&&(a=t),e=resolve(e,"data"),t=resolve(e,"metadata"));var n=getDataClient(e,a),i=getMetadataClient(t,a);return new LightblueClient(n,i)}function getHttpClient(e){return new NodeHttpClient(e)}var DataClient=require("./data.js"),MetadataClient=require("./metadata.js"),LightblueClient=require("./client.js"),query=require("./query.js"),NodeHttpClient=require("./nodehttp.js");require("./nglightblue.js");var resolve=require("./clientutil.js").resolve;exports.getDataClient=getDataClient,exports.getMetadataClient=getMetadataClient,exports.getClient=getClient,exports.field=query.field;
},{"./client.js":1,"./clientutil.js":2,"./data.js":3,"./metadata.js":6,"./nglightblue.js":8,"./nodehttp.js":9,"./query.js":10}],6:[function(require,module,exports){
function LightblueMetadataClient(t,e){this._httpClient=t,this._host=e}function NamesRequest(t,e){var s=e&&e.length>0?"s="+e.join(","):"";HttpRequest.call(this,"get",resolve(t,s))}function VersionsRequest(t,e){if(isEmpty(e))throw new Error("entityName required for versions request.");HttpRequest.call(this,"get",resolve(t,e))}function RolesRequest(t,e,s){HttpRequest.call(this,"get",resolve(t,e,s,"roles"))}function MetadataRequest(t,e,s){if(isEmpty(e)||isEmpty(s))throw new Error("entityName and version required for metadata request.");HttpRequest.call(this,"get",resolve(t,e,s))}var util=require("./clientutil"),http=require("./http"),isEmpty=util.isEmpty,resolve=util.resolve,HttpRequest=http.HttpRequest;module.exports=LightblueMetadataClient,LightblueMetadataClient.prototype._execute=function(t){return this._httpClient.execute(t)},LightblueMetadataClient.prototype.getNames=function(t){return this._execute(new NamesRequest(this._host,t))},LightblueMetadataClient.prototype.getVersions=function(t){return this._execute(new VersionsRequest(this._host,t))},LightblueMetadataClient.prototype.getMetadata=function(t,e){return this._execute(new MetadataRequest(this._host,t,e))},LightblueMetadataClient.prototype.getRoles=function(t,e){return this._execute(new RolesRequest(this._host,t,e))},NamesRequest.prototype=Object.create(HttpRequest.prototype),NamesRequest.prototype.constructor=NamesRequest,VersionsRequest.prototype=Object.create(HttpRequest.prototype),VersionsRequest.prototype.constructor=VersionsRequest,RolesRequest.prototype=Object.create(HttpRequest.prototype),RolesRequest.prototype.constructor=RolesRequest;
},{"./clientutil":2,"./http":4}],7:[function(require,module,exports){
function NgHttpClient(t){this._$http=t}module.exports=NgHttpClient,NgHttpClient.prototype.execute=function(t){return this._$http[t.method](t.url,t.body)};
},{}],8:[function(require,module,exports){
function LightblueProvider(){this._dataHost="",this._metadataHost=""}var LightblueClient=require("./client.js"),DataClient=require("./data.js"),MetadataClient=require("./metadata.js"),NgHttpClient=require("./nghttp.js"),url=require("url");"object"==typeof angular&&null!=angular&&"module"in angular?angular.module("lightblue",[]).provider("lightblue",LightblueProvider):console.warn("nglightblue loaded but angular is not. Make sure angular is loaded first."),LightblueProvider.prototype.setHost=function(t){this.setDataHost(url.resolve(t,"/data")),this.setMetadataHost(url.resolve(t,"/metadata"))},LightblueProvider.prototype.setDataHost=function(t){this._dataHost=t},LightblueProvider.prototype.setMetadataHost=function(t){this._metadataHost=t},LightblueProvider.prototype.$get=["$http",function(t){var e=new NgHttpClient(t),a=new DataClient(e,this._dataHost),i=new MetadataClient(e,this._metadataHost);return new LightblueClient(a,i)}];
},{"./client.js":1,"./data.js":3,"./metadata.js":6,"./nghttp.js":7,"url":41}],9:[function(require,module,exports){
function NodeHttpClient(e){this._exec=http.request,this._execSsl=https.request,e instanceof Object&&(this._auth=ifDefined(e.auth,null))}var q=require("q"),http=require("http"),https=require("https"),url=require("url"),util=require("./clientutil"),isDefined=util.isDefined,ifDefined=util.ifDefined;module.exports=NodeHttpClient,NodeHttpClient.prototype.execute=function(e){var t=q.defer(),n=t.promise,i=0===e.url.indexOf("https")?this._execSsl:this._exec,r=isDefined(e.body)?JSON.stringify(e.body):"",u=url.parse(e.url);u.method=e.METHOD,u.headers={"Content-Type":"application/json","Content-Length":r.length},null!=this._auth&&(u.auth=this._auth);var o=i(u,function(e){var n="";e.setEncoding("utf8"),e.on("data",function(e){n+=e}),e.on("end",function(){t.resolve(n)}),e.on("error",function(e){t.reject(e)})});return o.on("error",function(e){t.reject(e)}),o.write(r,"utf8"),o.end(),n.success=function(e){return n.then(e)},n.error=function(e){return n.then(null,e)},n};
},{"./clientutil":2,"http":16,"https":20,"q":44,"url":41}],10:[function(require,module,exports){
